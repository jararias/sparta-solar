...
SPARTA-Solar is designed to handle the complexity of solar radiation modeling with minimal effort. This guide will show you how to go from a geographic coordinate to a complete solar resource evaluation.

## 1. Setup your Credentials
SPARTA-Solar can automatically retrieve high-quality atmospheric data. To enable this, you need to provide your SoDA email once:

```python
import spartasolar
spartasolar.set_option("soda_user_email", "your.email@example.com")
```
...
grid_ds = spartasolar.regular_grid(
